...
{
    private Enemy_Skeleton enemy_Skeleton => GetComponentInParent<Enemy_Skeleton>();
    ...
    private void AttackTrigger()
    {
        ...
        {
            if (hit.GetComponent<Player>() != null) hit.GetComponent<Player>().Damage(enemy_Skeleton.transform);
        }
    }
